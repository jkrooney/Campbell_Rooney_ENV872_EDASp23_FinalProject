...
```{r visualize the range of HUC12 wind energy within each county using a box and whisker plot, echo=FALSE, fig.cap="Figure 1: Wind Energy Potential by County"}
