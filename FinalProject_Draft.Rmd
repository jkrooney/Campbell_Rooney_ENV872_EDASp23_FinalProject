...
```{r example code from Lesson 9 on finding centroids}
...
USCoalFields <- st_read('./Data/Spatial/US_Coal_Fields/US_Coal_Fields.shp')
...
```{r example from lesson nine load.geojson.data}
